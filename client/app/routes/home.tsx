...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col justify-center w-3xl">
      ...
      <p>Erstelle hier ein neues Spiel oder trete einem bestehenden Spiel über einen Einladungscode ein.</p>
      ...
      <div className="flex justify-center mt-4 gap-4 flex-col">
        ...
        <div className="flex gap-2">
          <Input id="game-input" placeholder="Code eingeben" onChange={(event) => setGameId(event.target.value) } />
            <Button onClick={() => navigate(`/game/${gameId}`)} disabled={gameId.length !== 6}>Spiel beitreten</Button>
        </div>
      </div>
    </div>
    </div>
